 ...
 \ \        / /          | | |      |__   __|                (_)           | |
  \ \  /\  / /__  _ __ __| | | ___     | | ___ _ __ _ __ ___  _ _ __   __ _| |
   \ \/  \/ / _ \| '__/ _` | |/ _ \    | |/ _ \ '__| '_ ` _ \| | '_ \ / _` | |
    ...
    print("Yellow specifies the letter is in the word, but position is wrong.")
...
def play_game():
    """
    putting the logic of word lenght
    and also the colored letters into one function
    so we can call it conveniently later
    when giving a player choice to play again
    """
